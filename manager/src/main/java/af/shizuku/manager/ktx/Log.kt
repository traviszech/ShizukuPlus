...
inline fun <reified T> T.logv(tag: String, message: String, throwable: Throwable? = null) = Timber.tag(tag).v(throwable, message)
inline fun <reified T> T.logi(tag: String, message: String, throwable: Throwable? = null) = Timber.tag(tag).i(throwable, message)
inline fun <reified T> T.logw(tag: String, message: String, throwable: Throwable? = null) = Timber.tag(tag).w(throwable, message)
inline fun <reified T> T.logd(tag: String, message: String, throwable: Throwable? = null) = Timber.tag(tag).d(throwable, message)
inline fun <reified T> T.loge(tag: String, message: String, throwable: Throwable? = null) = Timber.tag(tag).e(throwable, message)
